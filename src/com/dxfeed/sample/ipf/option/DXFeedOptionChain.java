...
public class DXFeedOptionChain {
	public static void main(String[] args) throws IOException {
		...
		List<OptionSeries<InstrumentProfile>> seriesList =
			new ArrayList<OptionSeries<InstrumentProfile>>(chain.getSeries()).subList(0, nMonths);

		System.out.printf("Requesting option quotes ...%n");
		Map<InstrumentProfile, Promise<Quote>> quotes = new HashMap<InstrumentProfile, Promise<Quote>>();
