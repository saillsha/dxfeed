...
public class DXFeedQuoteTable {
	...
	public static void main(String[] args) {
		...
		final DXFeedQuoteTable instance = new DXFeedQuoteTable();
	...
	private void initListeners() {
		...
		summarySub.addEventListener(new DXFeedEventListener<Summary>() {
			public void eventsReceived(List<Summary> events) {
